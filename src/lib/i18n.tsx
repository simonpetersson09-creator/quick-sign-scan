...
const sv: Dict = {
  ...
  guidePlace: "Placera dokumentet inom ramen",
  guideCloser: "Flytta närmare",
  guideFurther: "Håll lite längre bort",
  doneButton: "Klar",
...
const en: Dict = {
  ...
  guidePlace: "Place the document within the frame",
  guideCloser: "Move closer",
  guideFurther: "Hold a little further back",
  doneButton: "Done",
  ...
  premium_loading_product: "Loading subscription…",
